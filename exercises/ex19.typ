...
#solution[
  ...
  - $M = mif M_1 then M_2 melse M_3$: by inversion lemma (5) $Gamma tack.r M_1: Bool$, $Gamma tack.r M_2: T$ and $Gamma tack.r M_3$ are derivable. By inductive hypothesis $fv(M_1) subset.eq Dom(Gamma)$, $fv(M_2) subset.eq Dom(Gamma)$ and $fv(M_3) subset.eq Dom(Gamma)$, thus $fv(M) = fv(M_1) union fv(M_2) union fv(M_3) subset.eq Dom(Gamma)$
