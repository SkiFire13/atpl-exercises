...
#align(center)[
  #box(prooftree(
    ...
    rule(label: "(APP 2)", $2 app (M_p app 5) -> 2 app (mif even (5) then 5\/2 melse throw 5)$),
    rule(label: "(SUM RIGHT)", $fn y.y + 2 app (M_p app 5) -> fn y.y + 2 app (mif even (5) then 5\/2 melse throw 5)$),
