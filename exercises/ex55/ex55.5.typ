...
#[
  ...
  #align(center)[
    #box(prooftree(
      axiom(""),
      rule(label: "(RAISE APP 2)", $Mp app throw 2 -> throw 2$),
      rule(label: "(APP 2)", $2 app (Mp app throw 2) -> 2 app (throw 2)$),
      rule(label: "(SUM RIGHT)", $fn y.y + 2 app (Mp app throw 2) -> fn y.y + 2 app (throw 2)$),
      rule(label: "(TRY)", $try (fn y.y + 2 app (Mp app throw 2)) catch fn z.print(z) -> try (fn y.y + 2 app (throw 2)) catch fn z.print(z)$)
    ))
    #v(1em)
    #box(prooftree(
      axiom(""),
