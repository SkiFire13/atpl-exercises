...
#solution[
  - *Inversion of typing*: we add the following cases:
    - if $Gamma tack.r angle.l ell_j = M angle.r : T$ is derivable then $exists n, T_1...T_n. T = angle.l ell_i: T_i #h(1pt) ^ (i in 1..n) angle.r$ and $Gamma tack.r M : T_j$ derivable;
