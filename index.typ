...
#table(
  ...
  "23", smallcaps("(App')"),
  "24", smallcaps("(App')") + " and " + smallcaps("(Fun')"),
  "25", smallcaps("(True')") + " and " + smallcaps("(False')"),
  "26", smallcaps("(If')"),
  ...
  "39", smallcaps("(Type-Match-Gen-1)"),
  "40", smallcaps("(Type-Match-Gen-2)"),
  "41", "Define a list",
